...
\begin{table}[]
    \centering
    \caption{Progressive experiments modifications and key metrics. For each model family there is one vanilla progressive checkpoint, one low dimensional, one activation allignment and one combined activation allignment + low dim.}
