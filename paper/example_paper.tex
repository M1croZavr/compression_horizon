...
Table~\ref{tab:all_progressive_modifications} further highlights that Gemma~3 achieves noticeably lower information gain at comparable or smaller token counts, consistent with optimization constraints induced by logits softcapping \cite{gemma2}.
...
Table~\ref{tab:all_progressive_modifications} ablates projection dimension across model families.
