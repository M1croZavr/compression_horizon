...
\begin{itemize}
    ...
    \item We quantify attention-sink behavior during cramming and find that compression embeddings can capture substantial attention mass to position 0 in specific intermediate layers (often 20--60\%), with strong model-family dependence.
