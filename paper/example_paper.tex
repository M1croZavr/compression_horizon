...
Notably, Gemma~3 achieves lower information gain at shorter reconstructed lengths than Llama and Pythia, consistent with stronger architectural or training-time constraints (e.g., logits softcapping \cite{gemma2}), though we do not isolate the causal mechanism here.
...
If cramming preserves semantic information, conditioning on a compression embedding should preserve downstream capabilities that depend on the prefix.
