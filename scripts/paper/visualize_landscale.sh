...
for checkpoint in "${ALL_CHECKPOINTS[@]}"; do
    python scripts/paper/visualize_landscale_2pca.py --sample_id 0 --accuracy-only --mesh_resolution 30 --num-frames 10 --padding 0.5 --dataset_path artifacts/experiments_progressive/${checkpoint}/progressive_prefixes
done