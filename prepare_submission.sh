...
sed -i "s|mrsndmn/pg19|hf_anon_icml_2026/pg19|g" ./scripts/activation_distillation.py ./scripts/data/generate_pg19_paraphrases.py ./scripts/experiments.sh  ./scripts/hybrid_loss.py ./scripts/paper/visualize_trajectories.sh ./src/compression_horizon/train/arguments.py
...
rm -rf .cursor/ .github/ .git/ scripts/jobs paper notebooks prepare_submission.sh .github LICENSE jobs ./scripts/run_once
